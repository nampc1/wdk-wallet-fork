 ...
 * @property {number} amount - The amount of tokens to supply (in base unit).
 ...
 * @property {number} amount - The amount of tokens to borrow (in base unit).
 ...
 * @property {number} amount - The amount of tokens to repay (in base unit).
